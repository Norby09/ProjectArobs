...
class SlideDialogEducationUpdate extends Component {
    ...
    initRequirementUpdate = () => {
        ...
        this.props.updateTheRequirement(this.props.element.id,body,this.state.jobId);
    };
    render() {
        ...
        return (
            <div style={styles.inlineDiv}>
                ...
                >
                    ...
                    <DialogActions>
                        <Button onClick={this.initRequirementUpdate.bind(this)} color="primary">
                            Update
                        </Button>
...
const mapDispatchToProps = (dispatch) => {
    return {
        updateTheRequirement: (value,body,jobidentifier) => {
            dispatch(jobActions.updateRequirement(value,body,jobidentifier))
        },
    };
};
